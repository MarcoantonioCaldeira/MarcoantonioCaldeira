...
My main stack includes **Java, Spring Boot, Vue.js, PostgreSQL and SQL Server**, with hands-on experience applying **SOLID principles, Design Patterns and MVC** in production environments. Always learning — currently diving deeper into **AWS, Docker and Kotlin**.
